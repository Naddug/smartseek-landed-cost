...
function StatCard({ icon: Icon, label, value, change, positive, iconBg }: {
  ...
  return (
    <div className="bg-white rounded-lg p-3 border border-slate-200/80 flex flex-col gap-1.5">
      <div className="flex items-center justify-between">
        <div className={`w-7 h-7 rounded-md flex items-center justify-center ${iconBg}`}>
          <Icon className="w-3.5 h-3.5 text-white" />
        </div>
        <span className={`text-[10px] font-medium flex items-center gap-0.5 ${positive ? 'text-emerald-600' : 'text-red-500'}`}>
  ...
  return (
    <div className="relative rounded-2xl shadow-2xl border border-slate-200 w-full mx-auto max-w-5xl bg-white overflow-hidden" data-testid="img-preview-dashboard">
      <div className="bg-slate-800 px-4 py-2 flex items-center gap-2">
        ...
        <div className="flex-1 flex justify-center">
          <div className="bg-slate-700 rounded-md px-3 py-0.5 text-[9px] text-slate-400">smartseek.com/dashboard/analytics</div>
        </div>
      </div>
      <div className="flex h-72">
        <div className="w-40 bg-slate-900 p-3 flex flex-col gap-1 shrink-0">
          <div className="flex items-center gap-2 mb-3">
            <Logo size="sm" className="rounded-md w-8 h-8" />
        ...
        <div className="flex-1 p-4 bg-slate-50 overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            <div>
              <p className="text-xs font-semibold text-slate-800">Supplier Analytics</p>
              <p className="text-[9px] text-slate-500">Real-time performance metrics</p>
            </div>
            <div className="flex gap-1.5">
              <div className="bg-white border border-slate-200 text-[9px] px-2 py-1 rounded-md text-slate-600">Last 30 days</div>
              <div className="bg-blue-600 text-white text-[9px] px-2 py-1 rounded-md">Export</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2">
            <div className="col-span-3 bg-white rounded-lg p-3 border border-slate-200/80">
            ...
            <div className="col-span-2 bg-white rounded-lg p-3 border border-slate-200/80">
        ...
        <div className="flex-1 p-4 bg-slate-50 overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-[9px] text-slate-500">Wenzhou Neo Electric Co. — Chongqing, China</p>
            </div>
            <div className="flex gap-1.5">
              <div className="bg-emerald-100 text-emerald-700 text-[9px] px-2 py-1 rounded-md font-medium flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3" /> Verified
              </div>
              <div className="bg-white border border-slate-200 text-[9px] px-2 py-1 rounded-md text-slate-600">Download PDF</div>
            </div>
          </div>
