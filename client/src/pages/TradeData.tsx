          ...
          <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700">
            ...
            <CardContent className="space-y-2">
              {[
                ...
                <div key={item.name} className="flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors gap-2 min-w-0">
                  <span className="text-sm font-semibold text-slate-900 dark:text-slate-200 truncate min-w-0">{item.name}</span>
                  <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                    <span className="text-xs sm:text-sm font-semibold text-slate-900 dark:text-slate-100 whitespace-nowrap">{item.price}</span>
                    <span className={`text-xs font-medium flex items-center gap-0.5 whitespace-nowrap ${item.trend === "up" ? "text-emerald-600" : "text-red-600"}`}>
