...
const CAPABILITIES = [
  ...
  { icon: Target, label: "Supplier Discovery", desc: "Find & qualify suppliers globally", tooltip: "Search 25.2M+ suppliers by product, region, and certification. Get AI-ranked shortlists.", color: "text-indigo-600", bg: "bg-indigo-50", border: "border-indigo-100" },
