...
export type AuditEventType = "verification_state_change" | "document_uploaded" | "document_rejected" | "campaign_gate_passed" | "campaign_gate_waived" | "committee_decision" | "fraud_signal_created" | "fraud_signal_resolved" | "escalation_opened" | "escalation_closed" | "public_disclosure_published" | "moderation_action" | "admin_login" | "consent_recorded" | "partner_webhook_received";
...
export type ModerationAction = "approve" | "reject" | "request_edit" | "hide" | "escalate_fraud";
...
export type PublicTransparencyRecord = {
    id: string;
    publishedAt: string;
    category: "platform_status" | "campaign_decision" | "enforcement_action" | "process_update" | "incident_summary";
    title: string;
    summary: string;
