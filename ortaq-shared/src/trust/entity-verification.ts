...
export type CompanyCheck =
  | "mersis_registry_match"
  | "trade_registry_gazette"
  | "tax_status"
  | "beneficial_ownership"
  | "litigation_search"
  | "sanctions_screening"
  | "site_visit_or_field_call"
  | "bank_account_verification";

export const REQUIRED_COMPANY_CHECKS: CompanyCheck[] = [
  "mersis_registry_match",
  "trade_registry_gazette",
  "tax_status",
  "beneficial_ownership",
...
export type FounderCheck =
  ...
  | "pep_screening"
  | "sanctions_screening"
  | "linkedin_or_public_record_crosscheck"
  | "interview_or_call";

export const REQUIRED_FOUNDER_CHECKS: FounderCheck[] = [
  "identity_match",
  "pep_screening",
  "sanctions_screening",
];
