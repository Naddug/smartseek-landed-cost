...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-ortaq-border bg-ortaq-ink pb-[calc(4.5rem+env(safe-area-inset-bottom))] text-ortaq-bg md:pb-10">
      <Container>
        ...
        <div className="grid gap-10 py-10 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            <p className="mb-3 text-xs font-medium text-ortaq-bg/55">{t("footer.learnTitle")}</p>
            <ul className="space-y-2 text-sm leading-snug">
              <li><Link href="/nasil-calisir" className="text-ortaq-bg/80 hover:text-ortaq-bg">{t("footer.links.process")}</Link></li>
              <li><Link href="/sss" className="text-ortaq-bg/80 hover:text-ortaq-bg">{t("footer.links.faq")}</Link></li>
              <li><Link href="/sozluk" className="text-ortaq-bg/80 hover:text-ortaq-bg">{t("footer.links.glossary")}</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2 text-sm leading-snug">
              <li><Link href="/alan" className="text-ortaq-bg/80 hover:text-ortaq-bg">{t("footer.links.memberArea")}</Link></li>
