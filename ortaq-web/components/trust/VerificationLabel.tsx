...
const styles: Record<VerificationPublicLabel, string> = {
  not_submitted: "border-ortaq-border text-ortaq-ink-soft",
  under_review: "border-ortaq-border-strong text-ortaq-ink-muted",
  approved: "border-ortaq-trust/40 text-ortaq-trust",
  approved_with_conditions: "border-ortaq-trust/30 text-ortaq-trust",
  rejected: "border-ortaq-risk/40 text-ortaq-risk",
  suspended: "border-ortaq-risk/50 text-ortaq-risk",
  withdrawn: "border-ortaq-border-strong text-ortaq-ink-soft",
  expired: "border-ortaq-border text-ortaq-ink-soft",
};
