...
export function RiskBoard() {
  ...
  const deals: Deal[] = isTR ? [
    ...
    {
      name: "Çelik Tedariki",
      counterparty: "Alman alıcı · Hamburg",
      stage: "SGS",
      risk: "SGS bekleniyor · alıcı tarafta",
      riskType: "waiting",
      responsible: "Alıcı sorumlu · Pazartesi",
      days: "1G",
      amount: "€840K",
    },
    {
    ...
    },
    {
      ...
      counterparty: "Alman alıcı · Hamburg",
      stage: "SGS",
      risk: "SGS pending · buyer side",
      riskType: "waiting",
      responsible: "Buyer responsible · Monday",
      days: "1D",
      amount: "€840K",
    },
    {
