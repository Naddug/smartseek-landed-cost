...
export function RiskBoard() {
  ...
  const deals: Deal[] = isTR ? [
    ...
    },
    {
      ...
      stage: "Muayene",
      risk: "Muayene randevusu bekleniyor · Siam Metals'da",
      riskType: "waiting",
      responsible: "Siam Metals · yerinde muayene",
      days: "2G",
      amount: "€510K",
    },
    {
    ...
    },
    {
      ...
      counterparty: "Siam Metals · Bangkok",
      stage: "Inspection",
      risk: "Inspection appointment pending · Siam Metals side",
      riskType: "waiting",
      responsible: "Siam Metals · on-site inspection",
      days: "2D",
      amount: "€510K",
    },
    {
